...
import {
  ...
  applyStatusByExternalId,
  lookupInternalIdByExternalId,
  findOrCreateContact,
...
async function processMessage(
  ...
  // Resolve the contact/conversation locally (mirroring what
  // persistInboundMessage does) so a conversation first opened by a
  // reaction still fires conversation.created, then handle the reaction.
